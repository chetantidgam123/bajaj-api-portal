  ...
  const contactForm = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        ...
        const updatedValues =
          activeTab === "suggest"
            ? { ...values, is_suggest_api: true }
            : values;
        const payload = convertToPayload(
          activeTab === "suggest" ? "add-suggest-api" : "add-contact-us",
          updatedValues
        );
            ...
            <div className="modal-body contactus py-1">
              <div className="row pt-1">
                <div className="col-xl-5 col-lg-6 col-md-6 col-12 signUpsideBanner">
                  <div className="">
                    ...
                    <div className="authContent">
                      ...
                      <p>
                        We re here to help you get the most out of our APIs.
                        Whether you need technical support, have questions about
                        integration, or want to explore partnership
                ...
                <div className="col-xl-7 col-lg-6 col-md-6 col-12 ps-5">
                  <ul
                    className="nav nav-pills mb-3 d-flex justify-content-start mt-5"
                    id="pills-tab"
                    role="tablist"
                  >
                    <li className="nav-item" role="presentation">
                      <button
                        className="nav-link active contact-tabs-border"
                        id="pills-home-tab"
                        data-bs-toggle="pill"
                    ...
                    <li className="nav-item ms-3" role="presentation">
                      <button
                        className="nav-link contact-tabs-border"
                        ...
                        <form onSubmit={contactForm.handleSubmit}>
                          ...
                          <div className="mb-3">
                            <input
                              ...
                              value={contactForm.values.emailid}
                              onChange={contactForm.handleChange}
                              onBlur={contactForm.handleBlur}
                            />
                            {contactForm.touched.emailid &&
                          ...
                          <div className="mb-3">
                            <input
                              ...
                              value={contactForm.values.mobileno}
                              onChange={contactForm.handleChange}
                              onBlur={contactForm.handleBlur}
                            />
                            {contactForm.touched.mobileno &&
                          ...
                          <div className="mb-3">
                            <textarea
                              ...
                              onBlur={contactForm.handleBlur}
                            ></textarea>
                            {contactForm.touched.description &&
        ...
        <div className="container">
          <div className="row align-items-center justify-content-center">
            <div className="col-2 d-flex justify-content-center mb-3">
              ...
              <img
                src="/assets/img/Bajaj-new-campaign.png"
                alt=""
                width={"300px"}
              />
            </div>
