...
function Header() {
  ...
  const searchFilter = async (searchTerm) => {
    ...
    post_data(
      "portal/public",
      convertToPayload("serach-api-by-name", payload),
      {},
    )
      .then((response) => {
  ...
  const confirm_swal_call = () => {
    ...
    confirm_swal_with(
      callback,
      `To access the APIs your account is in Approval Process`,
    );
  };
    ...
    <div className="header">
      ...
      <div className="container-fluid bg-white">
        <div className="row d-flex justify-content-center align-items-center">
          ...
          <div className="col-xl-6 col-lg-6 col-md-7 col-sm-6 col-6">
            {/* Collapsible Content */}
            <div
            ...
            >
              {/* Center: Links */}
              <ul className="navbar-nav d-flex flex-column flex-lg-row justify-content-center align-items-center gap-lg-4 gap-2 mb-2 mb-lg-0 w-100">
                {token?.role == 1 && (
            ...
            {/* Search Input Field */}
            <div className="d-xl-none d-lg-none d-sm-block d-block col-12">
          ...
          <div className="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-4">
            ...
            <div className="d-flex justify-content-end align-items-center">
              {/* Search Input Field */}
              <div className="d-xl-block d-lg-block d-md-none d-sm-none d-none me-2">
                <div className="position-relative col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                  <i className="fa-solid fa-search position-absolute top-50 translate-middle-y ms-2 text-muted pointer-events-none"></i>
                  <input
                    type="text"
                    value={query}
              ...
              <div className="d-xl-none d-lg-none d-md-block d-sm-block d-block">
                <i
                  className="fa-solid fa-bars btn-mobile-blue me-1"
              ...
              {getTokenData() && (
                <Dropdown className="p-0 ">
                  ...
                  >
                    ...
                    >
                      {fullName ? (
                        getInitials(getTokenData().fullname.split(" ")[0])
                      ) : (
      ...
      <Modal show={show} onHide={() => setShow(false)} centered size="lg">
        ...
        <Modal.Body className="pt-0">
          <div className="col-12 px-3">
            <div className="row">
              <div className="col-xl-5 col-lg-5 col-md-5 col-12 signUpsideBanner mobilehideen">
                <img
      ...
      <div
        className="offcanvas offcanvas-start d-xl-none d-lg-none d-md-block d-sm-block d-block"
        tabIndex="-1"
        id="offcanvasExample"
